...
// Install from library manager: "Adafruit SSD1306 Wemos Mini OLED" (1.1.2)
#include <SPI.h>
#include <Wire.h>
...
#define LED_STATUS D5 // GPIO14
#define LED_FRIEND_1 D6
#define LED_FRIEND_2 D7
...
// OLED Display
Adafruit_SSD1306 g_display(OLED_RESET);
...
void identifyDevice() {
    ...
    hlogn("Identified device: name=", g_deviceName, "id=", g_deviceIdMe);
...
void oledConfigure()
{
  // by default, we'll generate the high voltage from the 3.3v line internally! (neat!)
   g_display.begin(SSD1306_SWITCHCAPVCC, 0x3C);  // initialize with the I2C addr 0x3C (for the 64x48)
}
...
void showUpdatedInfoScreen()
{
   ...
   g_display.print(g_deviceIdMe);
   g_display.print(' ');

   g_display.setTextColor(BLACK, WHITE);
   g_display.print(g_deviceName);
