...
void printHelpGlobal() {
  ...
  addConversationBlock("", "/mqtt-drop  drop MQTT", CONVO_CMD_COLOR, LEFT);
  addConversationBlock("", "/bt-clean   clear bonds", CONVO_CMD_COLOR, LEFT);
  addConversationBlock("", "/wifi *     WiFi mgmt", CONVO_CMD_COLOR, LEFT);
  addConversationBlock("", "/dbg *      diagnostics", CONVO_CMD_COLOR, LEFT);
}

void printHelpWifi() {
  ESP_LOGI(TAG_MM, "Listing /wifi subcommands");
  addConversationBlock("", "/wifi cmds:", CONVO_CMD_COLOR, LEFT);
  addConversationBlock("", "  drop    drop link", CONVO_CMD_COLOR, LEFT);
  addConversationBlock("", "  clean   wipe NVS", CONVO_CMD_COLOR, LEFT);
  addConversationBlock("", "  list    known nets", CONVO_CMD_COLOR, LEFT);
  addConversationBlock("", "  forget <ssid>", CONVO_CMD_COLOR, LEFT);
  addConversationBlock("", "  portal  open portal", CONVO_CMD_COLOR, LEFT);
}

void printHelpDbg() {
  ESP_LOGI(TAG_MM, "Listing /dbg subcommands");
  addConversationBlock("", "/dbg cmds:", CONVO_CMD_COLOR, LEFT);
  addConversationBlock("", "  chip    chip + MACs", CONVO_CMD_COLOR, LEFT);
  addConversationBlock("", "  mem     heap + stack", CONVO_CMD_COLOR, LEFT);
...
bool processWifiSubcommand(const String& message) {
  ...
  addConversationBlock("", "Unknown /wifi cmd:", CONVO_ERROR_COLOR, LEFT);
  printHelpWifi();
  return true;
}
...
bool processDbgSubcommand(const String& message) {
  ...
  addConversationBlock("", "Unknown /dbg cmd:", CONVO_ERROR_COLOR, LEFT);
  printHelpDbg();
  return true;
}
