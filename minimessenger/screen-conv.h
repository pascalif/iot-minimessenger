...
public:
    ...
    TextLine(const String&  _ts,
             uint16_t       _tsColor,
             const GFXfont* _tsFont,
             byte           _tsFontSize,
             byte           _tsHeightWithBottomMargin,
             uint16_t       _tsX,
             int16_t        _tsBox[4],
             const String&  _msg,
             uint16_t       _msgColor,
             const GFXfont* _msgFont,
             byte           _msgFontSize,
             byte           _msgHeightWithBottomMargin,
             uint16_t       _msgX,
             int16_t        _msgBox[4])
        : tsColor(_tsColor), tsFont(_tsFont), tsFontSize(_tsFontSize), tsHeightWithBottomMargin(_tsHeightWithBottomMargin), tsX(_tsX), msgColor(_msgColor),
          msgFont(_msgFont), msgFontSize(_msgFontSize), msgHeightWithBottomMargin(_msgHeightWithBottomMargin), msgX(_msgX) {
